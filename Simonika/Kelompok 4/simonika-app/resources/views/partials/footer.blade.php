...
<!-- Footer -->
<footer class="text-center text-lg-start text-white  mt-4" style="background-color: #929fba">
    <!-- Grid container -->
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                    ...
                    <a class="btn btn-primary btn-floating m-1" style="background-color: #3b5998"
                        href="https://www.facebook.com/tipoliwangi/" role="button"><i class="bi bi-facebook"></i></a>

                    <!-- Instagram -->
                    <a class="btn btn-primary btn-floating m-1" style="background-color: #ac2bac"
                        href="https://www.instagram.com/tipoliwangi/" role="button"><i class="bi bi-instagram"></i></a>
