...
<div class="container mt-4">
    ...
    <h3 class="text-uppercase text-center">Belum Melakukan Seminar Proposal</h3>
</div>
...
<div class="container mx-5">
    ...
    <div class="form-group row">
        <div class="col-md-11">
            <a href="/laporan/sempro/never/print" target="_blank" class="btn btn-secondary float-end mb-5"><i
