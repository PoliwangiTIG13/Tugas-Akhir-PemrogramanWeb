        ...
        <div class="col-lg-5">
            <main class="form-registration">
                <form action="/register" method="POST">
                    @csrf
                    <img class="mt-2 mb-4" src="{{ asset('dist/img/logo.png') }}" alt="logo" width="150" height="150"
                        style="display:block; margin:auto;">
                    <h1 class="h3 mb-3 fw-normal text-center">Registration Simonika Account</h1>
                    ...
                    <button class="w-100 btn btn-lg btn-primary mt-3" type="submit" style="border-radius: 20px"><i
                            class="bi bi-box-arrow-in-right me-2"></i>Registration</button>
                </form>
                <small class="mt-3 d-block text-center text-primary">Already Registered? <a href="/"
